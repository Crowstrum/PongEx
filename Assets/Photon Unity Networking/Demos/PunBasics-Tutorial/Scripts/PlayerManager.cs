...
namespace ExitGames.Demos.DemoAnimator
{
    ...
    public class PlayerManager : Photon.PunBehaviour, IPunObservable
    {
        ...
        public void Awake()
        {
            ...
            // #Important
            // used in PongGameManager.cs: we keep track of the localPlayer instance to prevent instanciation when levels are synchronized
        ...
        public void Update()
        {
            ...
            if (photonView.isMine)
            {
                ...
                if (this.Health <= 0f)
                {
                    //PongGameManager.Instance.LeaveRoom();
                }
            }
